...
class MeanReciprocalRank(RetrievalMetric):
    r"""
    Computes `Mean Reciprocal Rank <https://en.wikipedia.org/wiki/Mean_reciprocal_rank>`_.
    ...
    def _metric(self, preds: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        ...
        return reciprocal_rank(preds[valid_indexes], target[valid_indexes])
