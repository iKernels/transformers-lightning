...
class CosineSchedulerWithWarmup(SuperScheduler):
    r"""
    ...
    Example:
        >>> scheduler = ConstantSchedulerWithWarmup(hyperparameters, optimizer)
    """
    ...
    def lr_lambda(self, current_step):
        ...
        return max(0.0, 0.5 * (1.0 + math.cos(math.pi * float(self.hyperparameters.num_cycles) * 2.0 * progress)))
    ...
    def add_scheduler_specific_args(parser: ArgumentParser):
        ...
        super(CosineSchedulerWithWarmup, CosineSchedulerWithWarmup).add_scheduler_specific_args(parser)
