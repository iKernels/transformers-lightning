...
@pytest.mark.parametrize(
    ["test_file", "line_number", "expected_line", "total_len"], [
        ["tests/test_data/test1.tsv", 3, [3, 33115, 4156, "How can I reduce tummy fat?", "How do I reduce tummy?", True], 40],
        ["tests/test_data/test2.tsv", 54, [54, 522296, 3013, "What's it like to take a daily caffeine pill?", "How can I improve digestion?", False], 96],
        ["tests/test_data/test3.tsv", 13, [13, 351690, 490931, "How do I withdraw at Quora?", "How can I remove my account from Quora?", True], 17]
    ]
)
